...
import {getDairyList,getWasherList,getDrinkList,getGroceryList} from "../../../api/products/products"
import CategoryComponent from "../../../components/CategoryComponent";


const ProductListing = () => {
    const { img, root, card, item, imgContainer, content, container, headerCategory } = useStyles()
    // const pictures = [
...
//     }
    ...
    useEffect(() => {
        getDairyList().then(res=>setDataDairy(res.data))
        getWasherList().then(res=>setDataWasher(res.data))
        getDrinkList().then(res=>setDataDrinks(res.data))
        getGroceryList().then(res=>setDataGrocery(res.data))
